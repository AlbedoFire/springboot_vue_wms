<template>
    <div>
        <div style="margin-bottom: 5px;">
            <el-input v-model="name" placeholder="请输入账本名" suffix-icon="el-icon-search" style="width: 200px;"
        ...
        >
            ...
            <el-table-column prop="name" label="账本名" width="180">
            </el-table-column>
    ...
    export default {
        ...
        data() {
            return {
                ...
                rules: {
                    name: [
                        {required: true, message: '请输入账本名', trigger: 'blur'}
                    ]
                }
            }
        },
