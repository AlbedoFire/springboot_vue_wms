<template>
    <div>
        <div style="margin-bottom: 5px;">
            <el-input v-model="name" placeholder="请输入发票名" suffix-icon="el-icon-search" style="width: 200px;"
                      @keyup.enter.native="loadPost"></el-input>
            <el-select v-model="storage" placeholder="请选择账本" style="margin-left: 5px;">
                <el-option
            ...
            <el-button type="primary" style="margin-left: 5px;" @click="inGoods" v-if="user.roleId!=2">计入账单</el-button>
            <el-button type="primary" style="margin-left: 5px;" @click="outGoods" v-if="user.roleId!=2">取出账单</el-button>
        </div>
        ...
        >
            ...
            <el-table-column prop="name" label="发票名" width="180">
            </el-table-column>
            <el-table-column prop="storage" label="账本" width="180" :formatter="formatStorage">
            </el-table-column>
        ...
        <el-dialog
            ...
            <el-form ref="form" :rules="rules" :model="form" label-width="80px">
                <el-form-item label="发票名" prop="name">
                    <el-col :span="20">
                        <el-input v-model="form.name"></el-input>
                    </el-col>
                </el-form-item>
                <el-form-item label="账本" prop="storage">
                    <el-col :span="20">
                        <el-select v-model="form.storage" placeholder="请选择账本" style="margin-left: 5px;">
                            <el-option
                                    v-for="item in storageData"
                                    :key="item.id"
                                    :label="item.name"
    ...
    export default {
        ...
        data() {
            ...
            return {
                ...
                rules: {
                    name: [
                        {required: true, message: '请输入发票名', trigger: 'blur'}
                    ],
                    storage:[
                        {required: true, message: '请选择账本', trigger: 'blur'}
                    ],
                    goodstype:[
